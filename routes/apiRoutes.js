...
// Testing to see if a can add to noteDAta
// console.log("fresh");
// console.log(noteData)
// noteData.push({title: "push test", text: "push push"})
// console.log(noteData);
// const parseData = JSON.parse(noteData);
...
module.exports = function(app) {
  ...
  app.post("/api/notes", (req, res) => {
    ...
    // Create New Keu ID
    const { id } = req.body
    // Maybe add an ID based on noteaDat.length, then in app.delete, do another for in that updates all the ids
...
// So it doesnt look like unique ids are working
